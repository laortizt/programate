...
@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('GOD  KNOWS')])
          ...
          <div class="card-body ">
            ...
            <div class="bmd-form-group{{ $errors->has('idcountryFK') ? ' has-danger' : '' }} mt-2">
              <div class="input-group">
                ...
                <select class="form-control"  name='idcountryFK' placeholder="{{ __('País...') }}" value="{{ old('idcountryFK') }}"required >
                    <option selected>Selecione su país</option>
            ...
            <div class="form-check mr-auto ml-3 mt-3">
              <label class="form-check-label">
                ...
                {{ __('Acepto') }} <a href="#">{{ __('términos y condiciónes') }}</a>
              </label>
            </div>
          </div>
