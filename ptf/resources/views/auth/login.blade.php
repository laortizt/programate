...
@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('GOD  KNOWS')])

@section('content')
<div class="container" style="height: auto;">
  <div class="row align-items-center">
    <div class="col-md-9 ml-auto mr-auto mb-3 text-center">
      <!-- <h3>{{ __('Bienvenido a la plataforma de red profesional para freelancers en Latinoamerica.') }} </h3> -->
    </div>
    <div class="col-lg-6 col-md-6 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="{{ route('login') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-body">
            <!-- <p class="card-description text-center">{{ __('Digite su ') }} <strong>Correo</strong> {{ __('y ') }}<strong>Contraseña</strong> </p> -->
